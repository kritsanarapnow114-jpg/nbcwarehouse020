...
export default async function LoginPage({
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg,#eef3ee,#e6ede7)",
      }}
    >
      <div className="w-full max-w-sm rounded-[18px] border border-[#e7ebf1] bg-white p-8 shadow-[0_1px_2px_rgba(20,30,48,.04),0_6px_18px_rgba(20,30,48,.035)]">
        <div className="mb-7 flex items-center gap-3">
          <div className="flex h-10 w-10 flex-none items-center justify-center rounded-[9px] bg-[#1f8a5b] text-[15px] font-bold text-white">
            NB
          </div>
