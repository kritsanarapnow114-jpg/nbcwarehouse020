...
export default async function ReportsPage({
  ...
  const oee: DeckOee = {
    summary: {
      ...
      boxes: oeeDash.production.boxes,
      avgMinPerBox: oeeDash.production.avgMinPerBox,
      runMin: oeeDash.production.runMin,
      shiftPlanMin: oeeDash.production.shiftPlanMin,
      shiftBreakMin: oeeDash.production.shiftBreakMin,
    },
