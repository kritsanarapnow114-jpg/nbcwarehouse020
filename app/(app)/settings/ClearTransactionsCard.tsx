...
export function ClearTransactionsCard() {
  ...
  async function handleClear() {
    ...
    setConfirmText("");
    showToast("ลบเอกสาร + ล้างสต็อกแล้ว — เริ่มเลขรันใหม่");
  ...
  return (
    <Card>
      ...
      <p className="mb-4 text-[13px] leading-relaxed text-[#69748a]">
        ลบเอกสาร <b>รับสินค้า · ผลิต · จ่ายสินค้า · ย้ายที่เก็บ · ใบสั่งซื้อ (PO)</b> ออกทั้งหมด, ล้าง{" "}
        <b>สต็อกคงเหลือให้เป็น 0</b>, และ <b>รีเซ็ตเลขรันเอกสารใหม่</b> (เริ่มที่ 0001).
        <br />
        <span className="text-[#1f9d63]">
          เก็บไว้: รายการสินค้า · ที่จัดเก็บ · ปรับปรุงสต็อก · นับสต็อก · BOM
        </span>
        <br />
