...
export const NAV_GROUPS: NavGroup[] = [
  { key: "overview", en: "Overview", th: "ภาพรวม", items: ["dashboard"] },
  {
    ...
    en: "Inventory",
    th: "สินค้าคงคลัง",
    items: ["products", "aging", "locations", "map", "receive", "po", "issue", "ship", "customers", "adjust", "count", "nonstock"],
  },
  {
    key: "operations",
    en: "Operations",
...
export const PAGE_TITLES: Record<string, { title: string; sub: string }> = {
  ...
  "/issue": { title: "Transfer", sub: "โอนย้าย · FEFO outbound" },
  ...
  "/silo": { title: "Feed to SILO", sub: "โหลดเข้า SILO · เบิกไปรอโหลด → คนโหลดกรอกเวลา/เครื่อง/SILO" },
